...
export const REGEX_PRESETS: RegexPreset[] = [
  ...
  },
  {
    ...
    flags: "g",
    testText: "Contact logistics at support@privatools.com, dispatcher.ops@shipping-hub.co.uk, or dispatch@warehouse.local.",
  ...
  },
  {
    ...
    flags: "gm",
    testText: "https://privatools.com/tools/regex-studio?tab=replace&mode=dark#output\nhttp://localhost:3000/api/v1/health\nhttps://api.logistics.org:8443/dispatch?route=402",
